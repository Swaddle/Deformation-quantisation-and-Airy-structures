\chapter{Symplectic vector and Tate spaces}
    ...
    %    \end{prop}
        ...
        When \( \mathbf{k} =\mathbb{C}\), note that there is an isomorphism of vector spaces \(W_{\mathrm{Airy}} \cong W\). %this is not an isomorphism of symplectic vector spaces. The important thing to note is that 
